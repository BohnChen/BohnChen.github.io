...
int main(int argc, char **argv) {
  ...
  int *localPointerToHeap = new int(
      10); // localPointerToHeap本身位于栈上， localPointerToHeap指向堆区
  const char *stringToText =
      "helloworld"; // stringToText本身位于栈上，stringToText指向变量位于文字常量区的
