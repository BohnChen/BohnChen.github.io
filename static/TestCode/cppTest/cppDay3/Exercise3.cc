...
MyVector::MyVector()
    : _myvec(new int[10]{}), _length(0), _point(-1), _isfull(false),
      _isempty(true) {}

MyVector::~MyVector() { delete[] _myvec; }
...
bool MyVector::isEmpty() { return _isempty; }
bool MyVector::isFull() { return _isfull; }
